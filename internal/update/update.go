...
const (
	updateUrl    = "https://github.com/mumu-140/octopus-concurrency/releases/latest/download"
	updateApiUrl = "https://api.github.com/repos/mumu-140/octopus-concurrency/releases/latest"
)
